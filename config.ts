  ...
  sources: [
    {
      ...
      urls: [
        ...
        'https://www.tesla.com/api/tesla/header/v2',
        'https://www.tesla.com/api/tesla/footer/html/v1',
        'https://www.tesla.com/api/tesla/footer/html/v2',
      ],
    },
    {
      ...
      urls: [
        ...
        'https://www.tesla.cn/api/tesla/header/v2',
        'https://www.tesla.cn/api/tesla/footer/html/v1',
        'https://www.tesla.cn/api/tesla/footer/html/v2',
      ],
    },
    {
      ...
      urls: [
        ...
        'https://www.tesla.com/fr_fr/api/tesla/header/v2',
        'https://www.tesla.com/fr_fr/api/tesla/footer/html/v1',
        'https://www.tesla.com/fr_fr/api/tesla/footer/html/v2',
      ],
    },
  ],
};
